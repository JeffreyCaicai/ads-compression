...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "zh_CN": {
        ...
        "encoding_mode.screen_safe_high_motion": "Screen Safe - 屏端兼容高运动",
        "encoding_mode.h265_small_file": "H.265 Small File - 标准素材",
        "encoding_mode.h265_small_file_complex": "H.265 Small File - 复杂/高运动素材",
        "encoding_mode.h265_small_file_simple": "H.265 Small File - 简单/静态素材",
        "encoding_mode.h265_production_best_detail": "H.265 Production - 最佳细节",
        "encoding_mode.h265_production_best_detail_2pass": "H.265 Production - 最佳细节 (2-pass)",
        "encoding_mode.h265_production_auto_detail_2pass": "H.265 Production - 自动细节优化 (2-pass)",
        "encoding_mode.h265_smart_auto": "H.265 Smart Auto - 自动分析素材",
        "column.name": "文件名",
        ...
        "message.analyzing_content": "{name}: 正在分析视频复杂度...",
        "message.content_analysis_done": "{name}: 自动判断为 {complexity}，复杂度分数 {score}，目标视频码率 {bitrate}k。",
        "message.content_analysis_failed": "{name}: 复杂度分析失败，使用标准 H.265 码率 {bitrate}k。原因：{error}",
        "message.analyzing_auto_detail": "{name}: 正在分析生产细节风险...",
        "message.auto_detail_selected": "{name}: 自动选择 {profile}，风险分数 {score}，目标视频码率 {bitrate}k，目标帧率 {fps}fps，原因：{reasons}。",
        "message.auto_detail_failed": "{name}: 自动细节分析失败：{error}。回退到 Best Detail (2-pass)，目标视频码率 {bitrate}k。",
        "message.quality_passed": "{name}: 画质检查通过，SSIM {ssim}，细节保留 {detail}%。",
        "message.quality_retry_started": "{name}: 画质检查未达标，开始重试。原因：{reason}",
        "message.quality_retry_kept_maximum": "{name}: 重试后保留 Maximum 配置。",
        "message.quality_retry_restored_best": "{name}: 重试后恢复 Best 配置。",
        "message.quality_warning": "{name}: 画质警告，SSIM {ssim}，细节保留 {detail}%。原因：{reason}",
        "message.quality_check_failed": "{name}: 画质检查失败。原因：{reason}",
        "message.done": "处理完成。\n成功：{success}\n失败：{failed}\n取消：{cancelled}\n输出目录：{output_dir}\n报告：{report}",
    ...
    "en_US": {
        ...
        "encoding_mode.screen_safe_high_motion": "Screen Safe - High Motion",
        "encoding_mode.h265_small_file": "H.265 Small File - Standard Content",
        "encoding_mode.h265_small_file_complex": "H.265 Small File - Complex Motion",
        "encoding_mode.h265_small_file_simple": "H.265 Small File - Simple/Static",
        "encoding_mode.h265_production_best_detail": "H.265 Production - Best Detail",
        "encoding_mode.h265_production_best_detail_2pass": "H.265 Production - Best Detail (2-pass)",
        "encoding_mode.h265_production_auto_detail_2pass": "H.265 Production - Auto Detail (2-pass)",
        "encoding_mode.h265_smart_auto": "H.265 Smart Auto - Analyze Content",
        ...
        "message.analyzing_content": "{name}: analyzing video complexity...",
        "message.content_analysis_done": "{name}: detected {complexity}, score {score}, target video bitrate {bitrate}k.",
        "message.content_analysis_failed": "{name}: content analysis failed; using standard H.265 bitrate {bitrate}k. Reason: {error}",
        "message.analyzing_auto_detail": "{name}: analyzing production detail risk...",
        "message.auto_detail_selected": "{name}: selected {profile}, risk score {score}, target video bitrate {bitrate}k, target fps {fps}fps, reasons: {reasons}.",
        "message.auto_detail_failed": "{name}: auto detail analysis failed: {error}. Falling back to Best Detail (2-pass), target video bitrate {bitrate}k.",
        "message.quality_passed": "{name}: quality check passed, SSIM {ssim}, detail retention {detail}%.",
        "message.quality_retry_started": "{name}: quality check did not meet the target; starting retry. Reason: {reason}",
        "message.quality_retry_kept_maximum": "{name}: retry kept the Maximum profile.",
        "message.quality_retry_restored_best": "{name}: retry restored the Best profile.",
        "message.quality_warning": "{name}: quality warning, SSIM {ssim}, detail retention {detail}%. Reason: {reason}",
        "message.quality_check_failed": "{name}: quality check failed. Reason: {reason}",
    ...
    "id_ID": {
        ...
        "encoding_mode.screen_safe_high_motion": "Screen Safe - Gerak Tinggi Stabil",
        "encoding_mode.h265_small_file": "H.265 Small File - Standard Content",
        "encoding_mode.h265_small_file_complex": "H.265 Small File - Complex Motion",
        "encoding_mode.h265_small_file_simple": "H.265 Small File - Simple/Static",
        "encoding_mode.h265_production_best_detail": "H.265 Production - Best Detail",
        ...
        "message.analyzing_content": "{name}: menganalisis kompleksitas video...",
        "message.content_analysis_done": "{name}: terdeteksi {complexity}, skor {score}, target bitrate video {bitrate}k.",
        "message.content_analysis_failed": "{name}: analisis konten gagal; memakai bitrate H.265 standar {bitrate}k. Alasan: {error}",
        "message.analyzing_auto_detail": "{name}: menganalisis risiko detail produksi...",
        "message.auto_detail_selected": "{name}: memilih {profile}, skor risiko {score}, target bitrate video {bitrate}k, target fps {fps}fps, alasan: {reasons}.",
        "message.auto_detail_failed": "{name}: analisis auto detail gagal: {error}. Kembali ke Best Detail (2-pass), target bitrate video {bitrate}k.",
        "message.quality_passed": "{name}: pemeriksaan kualitas lulus, SSIM {ssim}, retensi detail {detail}%.",
        "message.quality_retry_started": "{name}: pemeriksaan kualitas belum memenuhi target; memulai percobaan ulang. Alasan: {reason}",
        "message.quality_retry_kept_maximum": "{name}: percobaan ulang mempertahankan profil Maximum.",
        "message.quality_retry_restored_best": "{name}: percobaan ulang mengembalikan profil Best.",
        "message.quality_warning": "{name}: peringatan kualitas, SSIM {ssim}, retensi detail {detail}%. Alasan: {reason}",
        "message.quality_check_failed": "{name}: pemeriksaan kualitas gagal. Alasan: {reason}",
